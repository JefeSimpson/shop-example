package org.github.jefesimpson.shop.example.json.deserializer;
...
import org.github.jefesimpson.shop.example.model.OrderStatus;
...
public class OrderDeserializer extends StdDeserializer<Order> implements DaoDeserializer<Client, Product>{
    ...
    public Dao<Client, Integer> daoOne() throws SQLException {
        return DaoManager.createDao(SimpleDatabaseUtils.connectionSource(), Client.class);
    }
